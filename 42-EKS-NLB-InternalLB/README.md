...
curl lbc-network-lb-internal-demo-7031ade4ca457080.elb.ap-northeast-1.amazonaws.com
```
...
ssh -i ../01-ekscluster-terraform-manifests/private-key/japanese.pem ec2-user@54.90.160.218

# NSLOOKUP Internal Network LB DNS
nslookup lbc-network-lb-internal-d34ab3da5f17aea1.elb.ap-northeast-1.amazonaws.com

# Internal Network LB Curl Test
curl lbc-network-lb-internal-d34ab3da5f17aea1.elb.ap-northeast-1.amazonaws.com
Observation: Should work

## Sample Output
Kalyans-MacBook-Pro:06-nlb-internal-terraform-manifests kdaida$ ssh -i ../01-ekscluster-terraform-manifests/private-key/japanese.pem ec2-user@54.90.160.218
...
[root@ip-10-0-101-207 ~]# nslookup lbc-network-lb-internal-d34ab3da5f17aea1.elb.ap-northeast-1.amazonaws.com
Server:		10.0.0.2
Address:	10.0.0.2#53

Non-authoritative answer:
Name:	lbc-network-lb-internal-d34ab3da5f17aea1.elb.ap-northeast-1.amazonaws.com
Address: 10.0.1.37

[root@ip-10-0-101-207 ~]# curl lbc-network-lb-internal-d34ab3da5f17aea1.elb.ap-northeast-1.amazonaws.com
<!DOCTYPE html>
<html>
