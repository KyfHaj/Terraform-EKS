...
resource "helm_release" "efs_csi_driver" {
  ...
  set {
    ...
    value = "602401143452.dkr.ecr.ap-northeast-1.amazonaws.com/eks/aws-efs-csi-driver" # Changes based on Region - This is for ap-northeast-1 Additional Reference: https://docs.aws.amazon.com/eks/latest/userguide/add-ons-images.html
  }       
