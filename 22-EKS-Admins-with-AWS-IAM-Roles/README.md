  ...
  mapRoles: |
    - rolearn: arn:aws:iam::905159657258:role/hr-dev-eks-nodegroup-role
      ...
      groups:
        ...
        - system:nodes
    - rolearn: arn:aws:iam::905159657258:role/eks-admin-role
      username: eks-admin
      groups:
        - system:masters
...
Kalyans-Mac-mini:01-ekscluster-terraform-manifests kalyanreddy$ aws sts get-caller-identity
{
    ...
    "Arn": "arn:aws:iam::905159657258:user/eksadmin1"
}
...
Kalyans-Mac-mini:01-ekscluster-terraform-manifests kalyanreddy$ aws sts get-caller-identity
{
    ...
    "Account": "905159657258",
    "Arn": "arn:aws:sts::905159657258:assumed-role/eks-admin-role/eksadminsession101"
}
Kalyans-Mac-mini:01-ekscluster-terraform-manifests kalyanreddy$ 
...
# Describe Cluster
aws eks --region ap-northeast-1 describe-cluster --name hr-dev-eksdemo1 --query cluster.status
...
- Login to AWS Mgmt Console
  - Username: eksadmin1
  - Password: @EKSUser101
- Go to EKS Servie: https://console.aws.amazon.com/eks/home?region=ap-northeast-1#
```t
# Error
Error loading clusters
User: arn:aws:iam::905159657258:user/eksadmin1 is not authorized to perform: eks:ListClusters on resource: arn:aws:eks:ap-northeast-1:905159657258:cluster/*
```  
