...
- Login to AWS Mgmt Console
  - **Username:** eksadmin2
  - **Password:** @EKSUser101
- **Access URL:** https://console.aws.amazon.com/eks/home?region=ap-northeast-1  
- Go to Services -> Elastic Kubernetes Service -> Clusters -> Click on **hr-dev-eksdemo1**
- **Error**
```t
# Error 
Error loading clusters
User: arn:aws:iam::905159657258:user/eksadmin2 is not authorized to perform: eks:ListClusters on resource: arn:aws:eks:ap-northeast-1:905159657258:cluster/*
```
...
## mapUsers TEMPLATE - Replaced with IAM User ARN
  mapUsers: |
    - userarn: arn:aws:iam::905159657258:user/eksadmin1
      username: eksadmin1
      groups:
        - system:masters     
    - userarn: arn:aws:iam::905159657258:user/eksadmin2
      username: eksadmin2
      groups:
        - system:masters              
...
data:
  mapRoles: |
    - groups:
      ...
      - system:nodes
      rolearn: arn:aws:iam::905159657258:role/hr-dev-eks-nodegroup-role
...
aws eks --region ap-northeast-1 update-kubeconfig --name hr-dev-eksdemo1 --profile eksadmin2
Observation:
1. It should fail
...
## ERROR MESSAGE
Kalyans-MacBook-Pro:01-ekscluster-terraform-manifests kdaida$ aws eks --region ap-northeast-1 update-kubeconfig --name hr-dev-eksdemo1 --profile eksadmin2

An error occurred (AccessDeniedException) when calling the DescribeCluster operation: User: arn:aws:iam::905159657258:user/eksadmin2 is not authorized to perform: eks:DescribeCluster on resource: arn:aws:eks:ap-northeast-1:905159657258:cluster/hr-dev-eksdemo1
...
aws iam attach-user-policy --policy-arn arn:aws:iam::905159657258:policy/eks-full-access-policy --user-name eksadmin2
```
```json
{
    "Version": "2012-10-17",
